...
export const events: EventItem[] = [
  ...
  },
  {
    ...
    heroImage: img.holi,
    gallery: [img.holi, img.festiveDecor, img.holiColour, img.crowdNight, img.fireworks, img.stageBeams],
    featured: true,
    sample: true,
  },
  {
  ...
  // Upcoming
  {
    ...
    heroImage: img.festiveDecor,
    gallery: [img.festiveDecor, img.fireworks, img.gathering],
    sample: true,
  },
  {
