...
export const processSteps = [
  {
    ...
    body: "We listen first — the occasion, the guests, the feeling you want people to leave with — and shape it into one clear idea.",
    deliverables: ["Discovery call or site visit", "Mood, theme and guest-experience direction", "First budget range"],
  ...
  },
  {
    title: "Planning",
    when: "Weeks before",
    body: "Venue, budget, timeline, vendors and permissions — all in one written plan, with one person accountable for it.",
    deliverables: ["Master timeline and run-sheet", "Vendor and venue coordination", "Transparent, line-by-line budget"],
    image: img.conferenceRoom,
    detail: img.corporateMeetup,
  },
  {
    title: "Design",
    when: "Weeks before",
    body: "Stage, décor, lighting mood and guest journey designed together, so every detail belongs to the same story.",
    deliverables: ["Stage and décor concept", "Lighting and colour mood", "Entry, seating and guest-flow plan"],
    image: img.weddingTableLong,
    detail: img.banquetWhite,
  },
  {
    title: "Production",
    when: "Build days",
    body: "Our own crew builds the stage, rigs the lights, tunes the sound and runs the LED — the technical backbone of the day.",
    deliverables: ["Stage fabrication and trussing", "Sound, lighting and LED set-up", "Full technical rehearsal"],
    image: img.stageBeams,
    detail: img.mixingDesk,
  },
  {
    title: "Execution",
    when: "Event day",
    body: "Show-flow, cues, artists and guests run on the ground by a team that has rehearsed every minute.",
    deliverables: ["Stage manager on headset", "Artist and anchor cueing", "Guest, vendor and crew coordination"],
    image: img.performerSmoke,
    detail: img.microphone,
  },
  {
    title: "Celebration",
    when: "The moment",
    body: "You stay present with your guests. We make sure the moment happens exactly as it should — then we clear up.",
    deliverables: ["You enjoy your own event", "Timed moments and send-offs", "Clean strike and venue hand-back"],
    image: img.confettiConcert,
    detail: img.sparklers,
  },
];
